                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('project_detail.store', ['project_id' => $projectDetailInfo['project_id']]) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mt-4">
                            ...
                            <x-input class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" type="file" name="upload_file" :value="old('upload_file')" />
                        </div>
                        <div class="mt-4">
