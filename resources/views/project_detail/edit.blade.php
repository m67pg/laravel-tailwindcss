        ...
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('project_detail.update', ['project_id' => $projectDetailInfo['project_id'], 'id' => $projectDetailInfo['project_detail']->id])}}" method="POST" enctype="multipart/form-data">
                        @if ($errors->any())
                        ...
                        <div class="mt-4">
                            ...
                            @if ($projectDetailInfo['project_detail']->upload_file)
                                ...
                                <button type="submit" class="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900" name="delete_button">{{ __('削除する') }}</button>
                            @else
