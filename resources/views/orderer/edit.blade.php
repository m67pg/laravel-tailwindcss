                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ isset($page) ? route('orderer.update', [$orderer->id, 'page' => $page]) : route('orderer.update', $orderer->id) }}" method="POST">
                        ...
                        <div class="mt-4">
                            ...
                            <input type="radio" name="display" value="1"{{ old('display', $orderer->display) == '1' ? ' checked' : '' }}>表示
                            <input type="radio" name="display" value="0"{{ old('display', $orderer->display) == '0' ? ' checked' : '' }}>非表示
                        </div>
                        <div class="mt-4">
