                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ isset($page) ? route('progress.update', [$progress->id, 'page' => $page]) : route('progress.update', $progress->id) }}" method="POST">
                        ...
                        <div class="mt-4">
                            ...
                            <input type="radio" name="display" value="1"{{ old('display', $progress->display) == '1' ? ' checked' : '' }}>表示
                            <input type="radio" name="display" value="0"{{ old('display', $progress->display) == '0' ? ' checked' : '' }}>非表示
                        </div>
                        <div class="mt-4">
