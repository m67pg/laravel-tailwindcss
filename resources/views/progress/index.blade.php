                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <table class="table-fixed">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="border px-4 py-2" style="word-break:break-all;">{{ $progress->name }}</td>
                                <td class="border px-4 py-2">{{ $progress->sort_order }}</td>
                                <td class="border px-4 py-2">{{ $progress->display == 1 ? '表示' : '非表示' }}</td>
                                <td class="border px-4 py-2"><a href="{{ isset($page) ? route('progress.edit', [$progress->id, 'page' => $page]) : route('progress.edit', $progress->id) }}">編集</a></td>
                            </tr>
                            @endforeach
                        </tbody>
                        <tfoot>
